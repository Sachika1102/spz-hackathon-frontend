...
export default function ProfileInfo({ onEdit }: ProfileInfoProps) {
  return (
    <div className="bg-white border border-gray-300 rounded-2xl w-[900px] h-[450px] mx-auto relative p-6">
        {/* 編集ボタン */}
        <button
          onClick={onEdit} // propsで受け取った関数を使用
            ...
            <div className="w-20 h-20 rounded-full bg-gray-200 overflow-hidden">
              <img 
                ...
                onError={(e) => {
                  ...
                  target.parentElement!.innerHTML = '<div class="w-full h-full bg-blue-100 flex items-center justify-center text-blue-600 text-2xl font-bold">田</div>';
                }}
              />
            </div>
          </div>
        ...
        <div className="mt-8">
          ...
          <p>フルスタック開発者として5年の経験があります。React、Node.js、データベース設計が得意です。</p>
        </div>
        ...
        <div className="flex gap-32 mt-6">
          <div>
            ...
            <a href="https://github.com/tanaka-taro" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">
              https://github.com/tanaka-taro
            </a>
          </div>
          <div className="ml-16">
            <p className="font-bold text-gray-600 mb-1">LinkedIn</p>
            <a href="https://linkedin.com/in/tanaka-taro" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">
